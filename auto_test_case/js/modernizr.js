...
Modernizr.addTest('mediaqueries', Modernizr.mq('only all'));// Web Audio API
...
Modernizr.addTest('raf', !!Modernizr.prefixed('requestAnimationFrame', window));// Detect support for svg filters - http://www.w3.org/TR/SVG11/filters.html.
...
// By Theodoor van Donge
Modernizr.addTest('scriptasync', 'async' in document.createElement('script'));// test if IE userdata supported
